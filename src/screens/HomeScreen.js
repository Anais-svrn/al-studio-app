...
import { styleFilters, wardrobeItems, looks, calendarDays, monthDays } from '../data/mockData';

export default function HomeScreen({ selectedStyle, setSelectedStyle, favoriteLooks, toggleFavorite }) {
